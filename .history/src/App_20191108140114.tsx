...
const defFriends: Friend[] = [{ id: "000001", name: "王元安", avatar: "http://img5.imgtn.bdimg.com/it/u=2630241800,682426215&fm=26&gp=0.jpg" },
...
function chatReducer(state: ChatDetailState = { friends: defFriends, messageMap: new Map() }, action: SendMesageAction|EnterChatAction) {
  switch (action.type) {
    ...
    case "enterChat":{
      ...
      console.log("enter chat"+JSON.stringify(newAction.friend))
      let newState = Object.assign( state,{ currentChat:state.messageMap.get(newAction.friend), currentChatFriend:newAction.friend })
      console.log("enter chat"+JSON.stringify(newState))
      return newState
    }
