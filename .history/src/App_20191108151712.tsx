...
function chatReducer(state: ChatDetailState = { friends: defFriends, messageMap: new Map() ,currentChatFriend:defFriends[0]}, action: SendMesageAction | EnterChatAction) {
  switch (action.type) {
    case "sendMessage": {
