...
const defFriends:Friend[]=[{name:"王元安",avatar:"http://b-ssl.duitang.com/uploads/item/201806/02/20180602175441_XM8Vc.jpeg"}]



function myReducer(state: ChatDetailState = { msgList: [] ,friends:[]}, action: SendMesageAction) {
  switch (action.type) {
    case "sendMessage":
