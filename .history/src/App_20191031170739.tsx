...
import { createStore, Action, Dispatch, combineReducers, applyMiddleware } from 'redux';
...
const  myMiddleware=({dispatch ,getState})=>(next:Dispatch)=>(action:Action)=>{
...
const store = createStore(combineReducers({myReducer}),applyMiddleware(myMiddleware))
