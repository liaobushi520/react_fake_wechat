...
class ImageMessage extends React.Component<ImageMessageProps> {
  constructor(props) {
    super(props);
  }
...
interface DialoguePanelProps {
 ...
 function  renderMessage(params:any) {
   return  <TextMessage text={params} friend={{ name: "lzj", avatar: "http://pic4.zhimg.com/50/v2-1adce42102e226eea2e96d19c116598c_hd.jpg" }} />
 }
