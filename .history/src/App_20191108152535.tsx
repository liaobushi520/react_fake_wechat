...
function chatReducer(state: ChatDetailState = { friends: defFriends, messageMap: new Map() ,currentChatFriend:defFriends[0],currentChat:[]}, action: SendMesageAction | EnterChatAction) {
  switch (action.type) {
    case "sendMessage": {
      ...
      console.log("before" + (state.messageMap.get(textMsg.friend)||[]).length)
      ...
      console.log("after" +  (newState==state))
    ...
    case "enterChat": {
      ...
      console.log("enter chat" + JSON.stringify(state.messageMap))
