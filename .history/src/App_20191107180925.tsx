...
const defFriends: Friend[] = [{ id: "000001", name: "王元安", avatar: "http://b-ssl.duitang.com/uploads/item/201806/02/20180602175441_XM8Vc.jpeg" }]


///js map key只能是number string 
function chatReducer(state: ChatDetailState = { friends: defFriends, messageMap: new Map() }, action: SendMesageAction) {
  switch (action.type) {
    case "sendMessage": {
      let textMsg = (action.message as TextMessage)
...
const contatcListMapStateToProps = (state: any) => ({
  frineds: state["chatReducer"].friends || []
})
