...
class TextMessage extends React.Component<TextMessageProps>{
  ...
  render() {
    console.log(typeof(this.props.text))
...
class DialoguePanel extends React.Component<DialoguePanelProps>{
  ...
  render() {
    return <ul>
      {
        this.props.msgList.map((item: string) => (
          <TextMessage text={item+""} friend={{ name: "lzj", avatar: "http://pic4.zhimg.com/50/v2-1adce42102e226eea2e96d19c116598c_hd.jpg" }} />
        ))
      }
    </ul>
  }
