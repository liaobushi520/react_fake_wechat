...
function contactItem(friend: Friend, messageMap: Map<Friend, Array<Message>>) {
  ...
  return <ContactItemV friend={friend} recentMsg={msgList[msgList.length - 1]} />
}
...
class ContactItemView extends React.Component<ContactItemViewProps> {
  ...
  render() {
    ...
    console.log("render"+this.props.friend.visible)

    return <Visiblity visible={this.props.friend.visible}>
      <div onClick={this.enterChat} className="Contact-item">
